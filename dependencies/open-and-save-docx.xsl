...
<?xml-model href="open-and-save-docx-check.sch" type="application/xml" schematypens="http://purl.oclc.org/dsdl/schematron"?>
<xsl:stylesheet exclude-result-prefixes="#all"
    ...
    <xsl:function as="xs:boolean" name="tan:xlsx-file-available" visibility="public">
        <!-- Alias for the function below -->
        <xsl:param as="item()?" name="element-with-attr-href-or-string-with-resolved-uri"/>
        <xsl:copy-of select="tan:archive-available($element-with-attr-href-or-string-with-resolved-uri)"/>
    </xsl:function>
    <xsl:function as="xs:boolean" name="tan:docx-file-available" visibility="public">
        <!-- Alias for the function below -->
        <xsl:param as="item()?" name="element-with-attr-href-or-string-with-resolved-uri"/>
        <xsl:copy-of select="tan:archive-available($element-with-attr-href-or-string-with-resolved-uri)"/>
    </xsl:function>
    ...
    <xsl:function name="tan:save-docx" use-when="$advanced-functions-available" visibility="public">
        <!-- Alias for the function below -->
        <xsl:param as="document-node()*" name="archive-components"/>
        <xsl:param as="xs:string" name="resolved-uri"/>
